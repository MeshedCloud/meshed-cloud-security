 ...
 */
@Slf4j
public class ConsumerOAuth2UserService  implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public ConsumerOAuth2UserService() {
        RestTemplate restTemplate = new RestTemplate();
        restTemplate.setErrorHandler(new OAuth2ErrorResponseErrorHandler());
        restTemplate.setInterceptors(Collections.singletonList(new BeforeInterceptor()));
        this.restOperations = restTemplate;
    }

    public static class BeforeInterceptor implements ClientHttpRequestInterceptor {
        ...
        public ClientHttpResponse intercept(HttpRequest request, byte[] body, ClientHttpRequestExecution execution) throws IOException {
            ...
            request.getHeaders().put("Authorization", Collections.singletonList(tokenValue));
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        Map<String, Object> userAttributes = (Map<String, Object>) responseBody.get("data");
